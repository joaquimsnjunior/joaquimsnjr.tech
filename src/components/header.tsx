    ...
    <header className="mb-16 space-y-4">
      <h1 className="text-4xl font-bold mb-4 animate-fade-in text-white">
        <span className="flex items-center gap-4">
          ...
          <div className="flex justify-end flex-col sm:flex-row sm:items-center sm:gap-4 w-full">
            <ScrambleText className="font-semibold leading-none flex-auto text-[2rem]" text="~/Joaquim_Silva" />
            <h3 className="text-[0.80rem] text-gray-400 leading-none sm:flex-wrap mt-2">home/kepa/Development/joaquimsnjr.tech</h3>
          </div>
        </span>
      </h1>
      <div className="flex flex-col gap-2 text-gray-350 group border p-4 border-gray-800/40 bg-[#161616]">
        ...
        <div className="mt-2 group border p-2 border-gray-800/50">
          ...
          <Link href="/projects" className="ml-4 group border p-1 border-gray-800 transition-colors hover:border-blue-400/50">
